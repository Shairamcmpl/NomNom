...
const initMap = (lat, long) => {
  ...
  const destination = { lat: 8.957678367035076, lng: 125.59648743948347 }; // Destination coordinates
        ...
        destinationMarker.addListener('click', () => {
          const content = `
            <div style="text-align: center;">
              <h3>ICT Cafe Library</h3>
              <img src= '${ictImage}' width='380' height='400'>
              <br>
              <br>
