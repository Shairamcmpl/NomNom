...
function calculateAndDisplayRoute(currentPos) {
  const destination = { lat: 8.955988031396709, lng: 125.59805905615487 };
      ...
      if (!destinationMarker) {
        ...
        destinationMarker.addListener('click', () => {
          ...
          <div style="text-align: center;">
            <h3>Khoy's FoodHub</h3>
            <img src='assets/images/maps/khoys.jpg' width='380' height='400'>
            <br>
            <br>
