...
function calculateAndDisplayRoute(currentPos) {
  const destination = { lat: 8.958516786585472, lng: 125.59722607753233 };
      ...
      if (!destinationMarker) {
        ...
        destinationMarker.addListener('click', () => {
          ...
          <div style="text-align: center;">
            <h3>SgSg</h3>
            <img src='assets/images/maps/sgsg.jpg' width='380' height='400'>
            <br>
            <br>
            <button onclick="window.location.href='stalls.html'" style="background-color: FF9B50;">View More</button>
        </div>
        `;"<img src='assets/images/maps/sgsg.jpg' width='380' height='400'><br><br><strong>SgSg</strong>";
