...
const initMap = (lat, long) => {
  ...
  const destination = { lat: 8.95872974395752, lng: 125.59683990478516 }; // Destination coordinates
        ...
        destinationMarker.addListener('click', () => {
          const content = `
            <div style="text-align: center;">
              <h3>Blyth's Canteen</h3>
              <img src= '${blythsImage}' width='380' height='400'>
              <br>
              <br>
