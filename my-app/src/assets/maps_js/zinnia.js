...
import zinniasImage from "/assets/images/maps/zinnia.jpg";
...
const initMap = (lat, long) => {
  ...
  const destination = { lat: 8.956311131012157, lng: 125.59800635156314 }; // Destination coordinates
    ...
    if (status === 'OK') {
      ...
      if (!destinationMarker) {
        destinationMarker = new google.maps.Marker({
          ...
          map: map,
          title: "Zinnia's Siomai Food Corner",
          icon: {
        ...
        destinationMarker.addListener('click', () => {
          const content = `
            <div style="text-align: center;">
              <h3>Zinnia's Siomai Food Corner</h3>
              <img src= '${zinniasImage}' width='380' height='400'>
              <br>
              <br>
