...
const initMap = (lat, long) => {
  ...
  const destination = { lat: 8.954894623805247, lng: 125.59758946823611 }; // Destination coordinates
        ...
        destinationMarker.addListener('click', () => {
          const content = `
            <div style="text-align: center;">
              <h3>Grazzias Food Service</h3>
              <img src= '${grazziasImage}' width='380' height='400'>
              <br>
              <br>
