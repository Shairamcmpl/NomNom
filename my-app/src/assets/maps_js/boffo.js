...
const initMap = (lat, long) => {
  ...
  const destination = { lat: 8.957365215203394, lng: 125.59570295588527 }; // Destination coordinates
        ...
        destinationMarker.addListener('click', () => {
          const content = `
            <div style="text-align: center;">
              <h3>Boffo Food Hub</h3>
              <img src= '${boffoImage}' width='380' height='400'>
              <br>
              <br>
