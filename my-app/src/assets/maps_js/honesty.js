...
function calculateAndDisplayRoute(currentPos) {
  const destination = { lat: 8.95824909210205, lng: 125.59654998779297 };
      ...
      if (!destinationMarker) {
        ...
        destinationMarker.addListener('click', () => {
          ...
          <div style="text-align: center;">
            <h3>Honesty Corner</h3>
            <img src='assets/images/maps/honesty.jpg' width='380' height='400'>
            <br>
            <br>
