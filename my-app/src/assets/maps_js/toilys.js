...
function calculateAndDisplayRoute(currentPos) {
  const destination = { lat: 8.956304347171367, lng: 125.59746193098884 };
    ...
    if (status === 'OK') {
      ...
      if (!destinationMarker) {
        destinationMarker = new google.maps.Marker({
          ...
          map: map,
          title: "Toily's Bubble Tea and Shawarma",
          icon: {
        ...
        destinationMarker.addListener('click', () => {
          ...
          <div style="text-align: center;">
            <h3>Toily's Bubble Tea and Shawarma</h3>
            <img src='assets/images/maps/toilys.jpg' width='380' height='400'>
            <br>
            <br>
