...
function calculateAndDisplayRoute(currentPos) {
  const destination = { lat: 8.958513745391679, lng: 125.5972137625309 };
    ...
    if (status === 'OK') {
      ...
      if (!destinationMarker) {
        destinationMarker = new google.maps.Marker({
          ...
          map: map,
          title: "Chirpy Snacks (NSB Branch)",
          icon: {
        ...
        destinationMarker.addListener('click', () => {
          ...
          <div style="text-align: center;">
            <h3>Chirpy Snakcs (NSB Branch)</h3>
            <img src='assets/images/maps/chirpynsb.jpg' width='380' height='400'>
            <br>
            <br>
