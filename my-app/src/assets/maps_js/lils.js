...
const initMap = (lat, long) => {
  ...
  const destination = { lat: 8.955646485637354, lng: 125.5971348511563 }; // Destination coordinates
        ...
        destinationMarker.addListener('click', () => {
          const content = `
            <div style="text-align: center;">
              <h3>Lil's Cafeteria</h3>
              <img src= '${lilsImage}' width='380' height='400'>
              <br>
              <br>
